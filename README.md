...
## Folder Structure:
1. models - All the saved models
2. data - processed csvs with the main dataset and data dictionary
3. TelecomCaseStudy_final.ipynb - Notebook with the whole implementation
 

## Please check the notebook to get the whole approach:
1. Data Understanding
2. Data Preparation
3. Deriving new features
4. SMOTE - Data Imbalance
5. PCA - Dimensionality reduction
6. Logistic Regression 
7. Random Forests - Gridsearch
8. XGBoost - Random Search
9. Recommendations.

## Achieved a test recall of 73% with logisitic regression and 69% with random forest.
